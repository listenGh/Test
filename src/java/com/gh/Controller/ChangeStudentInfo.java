 ...
 * @author lenovo
 */
@WebServlet(name = "ChangeStudentInfo", urlPatterns = {"/ChangeStudentInfo"})
public class ChangeStudentInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ChangeStudentInfo</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ChangeStudentInfo at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        StudentServiceImpl t2 = new StudentServiceImpl();
        StudentDaoImpl s = new StudentDaoImpl();
        String zid = (String) request.getSession().getAttribute("sId");
        Student t = s.search(zid, "Student");
//        t.setZid(zid);
