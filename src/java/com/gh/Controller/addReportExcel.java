 ...
 * @author lenovo
 */
@WebServlet(name = "addReportExcel", urlPatterns = {"/addReportExcel"})
public class addReportExcel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet addReportExcel</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet addReportExcel at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//                    File excelFile = new File(path + fileName);
                    ...
                    Workbook workbook = ExcelUtils2.readExcel(in);
                    ArrayList<Map<String, String>> list = ExcelUtils2.analysisWorkbook(workbook);
                    for (Map<String, String> map : list) {
                        String sid = null, sname = null, cname = null, classId = null,cId=null;
                        int score = 0;
                        ...
                        t.submitGrade(new Report(sid, sname, cId, cname, score, classId));
                    }
                }
            }
